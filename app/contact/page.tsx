    ...
    <HeroBackground>
      ...
      <section className="flex items-center justify-center min-h-screen xl:min-h-[1024px] px-6 pb-11 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          ...
          <div className="absolute top-8 lg:top-16 right-0 lg:right-[60px] transform -rotate-[-9.24deg] opacity-100 overflow-hidden lg:hidden">
            <Image
        ...
        <div className="mt-20 max-w-[1155px] flex w-full relative z-10 flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="max-w-[340px] flex flex-col justify-center items-start gap-4">
            ...
            {/* Main Heading */}
            <h1 className="text-white font-['Plus_Jakarta_Sans'] text-[36px] font-semibold leading-[44px] tracking-[-0.72px] text-left lg:text-[72px] lg:leading-[90px] lg:tracking-[-1.44px]">
              Our office
            </h1>

            {/* Contact Details */}
            <div className="self-stretch text-white font-['Plus_Jakarta_Sans'] text-sm font-normal leading-5 lg:text-lg lg:font-medium lg:leading-7">
          ...
          <div className="flex w-full lg:w-[581px] p-3 flex-col items-end gap-3 rounded-[22px] outline outline-1 outline-[#E9EAEB] bg-[#FDFDFD]">
