          ...
          >
            <PartnersSwiper 
              logos={[
                ...
                { src: "/imgs/logo-mf/Check-Point-2024-logo-color.png", href: "https://www.checkpoint.com/", alt: "Checkpoint" },
                { src: "/imgs/logo-mf/cisco.png", href: "https://www.cisco.com/", alt: "Cisco" },
                { src: "/imgs/logo-mf/CrowdStrike_Logo_2023_Secondary_Red.png", href: "https://www.crowdstrike.com/", alt: "CrowdStrike" },
                { src: "/imgs/logo-mf/Darktrace.png", href: "https://www.darktrace.com/", alt: "Darktrace" },
                { src: "/imgs/logo-mf/datto.png", href: "https://www.datto.com/", alt: "Datto" },
                { src: "/imgs/logo-mf/dell.png", href: "https://www.dell.com/", alt: "Dell" },
                { src: "/imgs/logo-mf/Fortinet.png", href: "https://www.fortinet.com/", alt: "Fortinet" },
                { src: "/imgs/logo-mf/Google-Cloud-Logo.png", href: "https://cloud.google.com/", alt: "Google Cloud" },
                { src: "/imgs/logo-mf/H3C.png", href: "https://www.h3c.com/", alt: "H3C" },
                { src: "/imgs/logo-mf/hpe_pri_grn_pos_rgb.png", href: "https://www.hpe.com/", alt: "HPE" },
                { src: "/imgs/logo-mf/huawei.png", href: "https://www.huawei.com/", alt: "Huawei" },
                { src: "/imgs/logo-mf/IBM.png", href: "https://www.ibm.com/", alt: "IBM" },
                { src: "/imgs/logo-mf/Lenovo-Logo.png", href: "https://www.lenovo.com/", alt: "Lenovo" },
                { src: "/imgs/logo-mf/Logitech_logo.svg.png", href: "https://www.logitech.com/", alt: "Logitech" },
                { src: "/imgs/logo-mf/mcafee.png", href: "https://www.mcafee.com/", alt: "McAfee" },
                { src: "/imgs/logo-mf/microsoft.png", href: "https://www.microsoft.com/", alt: "Microsoft" },
                { src: "/imgs/logo-mf/panw_CMYK_Logo_Positive.png", href: "https://www.paloaltonetworks.com/", alt: "Palo Alto Networks" },
                { src: "/imgs/logo-mf/Ruckus_logo_black-orange.png", href: "https://www.ruckusnetworks.com/", alt: "Ruckus" },
                { src: "/imgs/logo-mf/Sophos.png", href: "https://www.sophos.com/", alt: "Sophos" },
                { src: "/imgs/logo-mf/Synology_logo_Black.png", href: "https://www.synology.com/", alt: "Synology" },
                { src: "/imgs/logo-mf/trend-micro.png", href: "https://www.trendmicro.com/", alt: "Trend Micro" },
                { src: "/imgs/logo-mf/Ubiquiti-Networks-Logo.png", href: "https://ui.com/", alt: "Ubiquiti" },
                { src: "/imgs/logo-mf/Veeam_main_logo_without_contor_RGB.png", href: "https://www.veeam.com/", alt: "Veeam" },
                { src: "/imgs/logo-mf/vmware-logo-black.png", href: "https://www.vmware.com/", alt: "VMware" },
                { src: "/imgs/logo-mf/watchguard-logo.png", href: "https://www.watchguard.com/", alt: "WatchGuard" },
                { src: "/imgs/logo-mf/zscaler-logo 1.png", href: "https://www.zscaler.com/", alt: "Zscaler" }
              ]}
            />
          </motion.div>
        </div>
