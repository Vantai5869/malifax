...
export default function ServiceCard({ title, iconSrc }: ServiceCardProps) {
  return (
    ...
    >
      <div className="flex h-full p-4 pr-[10px] items-center xl:flex-col xl:items-start gap-4 self-stretch rounded-2xl outline outline-1 outline-[#E9EAEB] bg-[linear-gradient(247deg,#ECF9FF_0%,#FFF_100%)]">
